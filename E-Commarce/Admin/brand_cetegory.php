...
<body>
    ...
    $sql = "SELECT id,status,cetegory_name,brand_name, COUNT(*) as total_products FROM product WHERE brand_name = '$brand' GROUP BY cetegory_name";
    $obj = new database();
    ...
    <div class="container-fluid text-center">
        <h2 class="text-center">All Cetegory of <?=$brand?></h2>
        <br>
